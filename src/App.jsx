...
const PROJECTS = [
  {
    ...
    tags: ['Team Lead', 'Flash', 'HTML', 'WebGL', 'JavaScript', 'JIRA'],
    live: '',
    code: '',
    badge: 'Enterprise',
    image: macysImg
  },
  {
    ...
    description:
      'As Technical Director at Infosys, I led the creation of ecom websites for corporate clients. I worked within a full enterprise pipeline alongside brilliant designers, engineers, and stakeholders to validate concepts quickly and translate them into production-ready directions.',
